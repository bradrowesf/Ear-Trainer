...
class Exercise:
    ...
    def __init__(self, player, name, count, p_duration, m_duration, mode, keys, l_keys) -> None:
    ...
    def get_key_duration(self, series):
    ...
    def identify_key_center(self, key_center):
        ...
        notes = self.m_u.build_from_intervals(key_id_value, "Major")
    ...
    def output_series_information(self, series, strings, key, position):
        """Visual for series"""

        print("*****")
        print(f"Series: {series + 1} of {self.count}")
        print(f"String: {strings}")
        print(f"Key: {self.key_string(key)}")
...
class OneStringParent(Exercise):
    ...
    def do_exercise(self):
        ...
        for series in range(0, self.count):
            ...
            super().identify_key_center(key_center)

            # Play the test notes
            test_notes = self.m_u.build_note_list(
                low_note, high_note, self.mode, key_center)
    ...
    def do_exercise(self):
        ...
        for series in range(0, self.count):
            ...
            super().output_series_information(
                series, guitar_string_text, key_center, "Full String")
...
class OnePosition(Exercise):
    ...
    def do_exercise(self):
        ...
        for series in range(0, self.count):
            ...
            super().output_series_information(
                series, "All Strings", key_center, position)
...
class Sequence(Exercise):
    ...
    def do_exercise(self):
        ...
        for series in range(0, self.count):
            ...
            # Let us know about the series
            super().output_series_information(series, "All Strings", key_center, position_str)
...
class Simon(Exercise):
    ...
    def do_exercise(self):
        ...
        for series in range(self.count):
            ...
            test_notes = self.m_u.build_note_list(
                root, high_note, self.mode, key_center)
